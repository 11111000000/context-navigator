...
(defconst context-navigator-i18n--dict
  '((:add-from-text
    ...
    (:clear-group
     ...
     (ja . "グループをクリア"))
    (:clear-group-tip
     (en . "Clear current group's items (x)")
     (ru . "Очистить элементы текущей группы (x)")
     (fr . "Effacer les éléments du groupe courant (x)")
     (de . "Aktuelle Gruppenobjekte leeren (x)")
     (es . "Vaciar elementos del grupo actual (x)")
     (uk . "Очистити елементи поточної групи (x)")
     (be . "Ачысціць элементы бягучай групы (x)")
     (zh . "清空当前分组的条目（x）")
     (ja . "現在のグループの項目をクリア（x）"))
    (:clear-gptel
     (en . "clear gptel")
    ...
    (:clear-tip
     (en . "Clear gptel context (X)")
     (ru . "Очистить контекст gptel (X)")
     (fr . "Effacer le contexte gptel (X)")
     (de . "gptel-Kontext leeren (X)")
     (es . "Limpiar el contexto de gptel (X)")
     (uk . "Очистити контекст gptel (X)")
     (be . "Ачысціць кантэкст gptel (X)")
     (zh . "清除 gptel 上下文 (X)")
     (ja . "gptel のコンテキストをクリア (X)"))
